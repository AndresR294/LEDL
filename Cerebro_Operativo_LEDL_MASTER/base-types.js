...
exports.rpcDataToBuffer = exports.bufferToRpcData = exports.rpcDataToBigInt = exports.rpcDataToNumber = exports.numberToRpcStorageSlot = exports.numberToRpcQuantity = exports.rpcQuantityToBigInt = exports.rpcQuantityToNumber = exports.rpcFloat = exports.rpcQuantityAsNumber = exports.rpcUnsignedInteger = exports.rpcAddress = exports.rpcStorageSlotHexString = exports.rpcStorageSlot = exports.rpcHash = exports.rpcData = exports.rpcQuantity = void 0;
const ethereumjs_util_1 = require("@nomicfoundation/ethereumjs-util");
const t = __importStar(require("io-ts"));
const BigIntUtils = __importStar(require("/data/data/com.termux/files/home/Cerebro_Operativo_LEDL/07_TRANS_DATA/node_modules/viem/_cjs/../util/bigint"));
const errors_1 = require("/data/data/com.termux/files/home/Cerebro_Operativo_LEDL/07_TRANS_DATA/node_modules/viem/_cjs/errors");
const errors_list_1 = require("/data/data/com.termux/files/home/Cerebro_Operativo_LEDL/07_TRANS_DATA/node_modules/viem/_cjs/errors-list");
...
exports.rpcData = new t.Type("DATA", Buffer.isBuffer, (u, c) => isRpcDataString(u) ? t.success(Buffer.from((0, ethereumjs_util_1.toBytes)(u))) : t.failure(u, c), t.identity);
exports.rpcHash = new t.Type("HASH", (v) => Buffer.isBuffer(v) && v.length === HASH_LENGTH_BYTES, (u, c) => isRpcHashString(u) ? t.success(Buffer.from((0, ethereumjs_util_1.toBytes)(u))) : t.failure(u, c), t.identity);
...
exports.rpcAddress = new t.Type("ADDRESS", (v) => Buffer.isBuffer(v) && v.length === ADDRESS_LENGTH_BYTES, (u, c) => isRpcAddressString(u)
    ? t.success(Buffer.from((0, ethereumjs_util_1.toBytes)(u)))
...
function bufferToRpcData(buffer, padToBytes = 0) {
    let s = (0, ethereumjs_util_1.bytesToHex)(buffer);
...
function rpcDataToBuffer(data) {
    ...
    return Buffer.from((0, ethereumjs_util_1.toBytes)(data));
}
