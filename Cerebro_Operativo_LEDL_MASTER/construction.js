...
const date_1 = require("/data/data/com.termux/files/home/Cerebro_Operativo_LEDL/07_TRANS_DATA/node_modules/viem/_cjs/util/date");
...
async function createProvider(config, networkName, artifacts, experimentalHardhatNetworkMessageTraceHooks = [], extenders = []) {
    ...
    if (networkName === constants_1.HARDHAT_NETWORK_NAME) {
        ...
        const { createHardhatNetworkProvider } = await Promise.resolve().then(() => __importStar(require("/data/data/com.termux/files/home/Cerebro_Operativo_LEDL/07_TRANS_DATA/node_modules/viem/_cjs/hardhat-network/provider/provider")));
        let forkConfig;
        ...
        const { getForkCacheDirPath } = require("/data/data/com.termux/files/home/Cerebro_Operativo_LEDL/07_TRANS_DATA/node_modules/viem/_cjs/hardhat-network/provider/utils/disk-cache");
