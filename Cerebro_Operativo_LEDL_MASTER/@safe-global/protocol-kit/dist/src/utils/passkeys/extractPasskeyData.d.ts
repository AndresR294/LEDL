import { ExtractedPasskeyData, PasskeyCoordinates } from '../../types';
/**
 ...
 */
export declare function extractPasskeyData(passkeyCredential: Credential): Promise<ExtractedPasskeyData>;
/**
 ...
 */
export declare function getP256VerifierAddress(chainId: string): string;
