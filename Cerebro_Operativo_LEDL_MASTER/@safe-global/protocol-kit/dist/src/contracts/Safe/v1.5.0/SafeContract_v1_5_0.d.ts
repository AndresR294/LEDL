...
import { SafeContract_v1_5_0_Abi, SafeContract_v1_5_0_Contract, SafeContract_v1_5_0_Function, SafeTransaction, TransactionOptions, TransactionResult } from '@safe-global/types-kit';
/**
 * SafeContract_v1_5_0  is the implementation specific to the Safe contract version 1.5.0.
 *
 * This class specializes in handling interactions with the Safe contract version 1.5.0 using Ethers.js v6.
 *
 * @extends SafeBaseContract<SafeContract_v1_5_0_Abi> - Inherits from SafeBaseContract with ABI specific to Safe contract version 1.5.0.
 * @implements SafeContract_v1_5_0_Contract - Implements the interface specific to Safe contract version 1.5.0.
 */
declare class SafeContract_v1_5_0 extends SafeBaseContract<SafeContract_v1_5_0_Abi> implements SafeContract_v1_5_0_Contract {
    /**
     ...
     */
    constructor(chainId: bigint, safeProvider: SafeProvider, isL1SafeSingleton?: boolean, customContractAddress?: string, customContractAbi?: SafeContract_v1_5_0_Abi, deploymentType?: DeploymentType);
    /**
     * @returns Array[safeContractVersion]
     */
    VERSION: SafeContract_v1_5_0_Function<'VERSION'>;
    /**
     * @param args - Array[owner, txHash]
     * @returns Array[approvedHashes]
     */
    approvedHashes: SafeContract_v1_5_0_Function<'approvedHashes'>;
    /**
     ...
     * @returns Empty array
     */
    checkNSignatures: SafeContract_v1_5_0_Function<'checkNSignatures'>;
    /**
     ...
     * @returns Empty array
     */
    checkNSignaturesWithExecutor: (args: [executor: `0x${string}`, dataHash: `0x${string}`, signatures: `0x${string}`, requiredSignatures: bigint]) => Promise<[]>;
    /**
     ...
     * @returns Empty array
     */
    checkSignatures: SafeContract_v1_5_0_Function<'checkSignatures'>;
    /**
     ...
     */
    domainSeparator: SafeContract_v1_5_0_Function<'domainSeparator'>;
    /**
     * Returns array of modules.
     * @param args - Array[start, pageSize]
     * @returns Array[Array[modules], next]
     */
    getModulesPaginated: SafeContract_v1_5_0_Function<'getModulesPaginated'>;
    /**
     * Returns the list of Safe owner accounts.
     * @returns Array[Array[owners]]
     */
    getOwners: SafeContract_v1_5_0_Function<'getOwners'>;
    /**
     * Reads `length` bytes of storage in the current contract
     * @param args - Array[offset, length]
     * @returns Array[storage]
     */
    getStorageAt: SafeContract_v1_5_0_Function<'getStorageAt'>;
    /**
     * Returns the Safe threshold.
     * @returns Array[threshold]
     */
    getThreshold: SafeContract_v1_5_0_Function<'getThreshold'>;
    /**
     ...
     */
    getTransactionHash: SafeContract_v1_5_0_Function<'getTransactionHash'>;
    /**
     * Checks if a specific Safe module is enabled for the current Safe.
     * @param args - Array[moduleAddress]
     * @returns Array[isEnabled]
     */
    isModuleEnabled: SafeContract_v1_5_0_Function<'isModuleEnabled'>;
    /**
     * Checks if a specific address is an owner of the current Safe.
     * @param args - Array[address]
     * @returns Array[isOwner]
     */
    isOwner: SafeContract_v1_5_0_Function<'isOwner'>;
    /**
     * Returns the Safe nonce.
     * @returns Array[nonce]
     */
    nonce: SafeContract_v1_5_0_Function<'nonce'>;
    /**
     * @param args - Array[messageHash]
     * @returns Array[signedMessages]
     */
    signedMessages: SafeContract_v1_5_0_Function<'signedMessages'>;
    /**
...
export default SafeContract_v1_5_0;
