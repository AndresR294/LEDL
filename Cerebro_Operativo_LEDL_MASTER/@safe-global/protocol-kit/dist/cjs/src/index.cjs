...
__export(src_exports, {
  ...
  adjustVInSignature: () => adjustVInSignature,
  buildContractSignature: () => buildContractSignature,
  buildSignatureBytes: () => buildSignatureBytes,
  calculateSafeMessageHash: () => calculateSafeMessageHash,
  calculateSafeTransactionHash: () => calculateSafeTransactionHash,
  ...
  generatePreValidatedSignature: () => generatePreValidatedSignature,
  generateSignature: () => generateSignature,
  generateTypedData: () => generateTypedData,
  getChainIdFromEip3770NetworkPrefix: () => getChainIdFromEip3770NetworkPrefix,
  ...
  getEip3770NetworkPrefixFromChainId: () => getEip3770NetworkPrefixFromChainId,
...
var networks = [
  ...
  { chainId: 25363n, shortName: "fluent" },
  ...
  { chainId: 31611n, shortName: "mezo-testnet" },
  { chainId: 31612n, shortName: "mezo" },
...
function getChainIdFromEip3770NetworkPrefix(prefix) {
...
var SafeFeature = /* @__PURE__ */ ((SafeFeature2) => {
  SafeFeature2["SAFE_TX_GAS_OPTIONAL"] = "SAFE_TX_GAS_OPTIONAL";
  SafeFeature2["SAFE_TX_GUARDS"] = "SAFE_TX_GUARDS";
  SafeFeature2["SAFE_FALLBACK_HANDLER"] = "SAFE_FALLBACK_HANDLER";
  SafeFeature2["ETH_SIGN"] = "ETH_SIGN";
  SafeFeature2["ACCOUNT_ABSTRACTION"] = "ACCOUNT_ABSTRACTION";
  SafeFeature2["REQUIRED_TXGAS"] = "REQUIRED_TXGAS";
  SafeFeature2["SIMULATE_AND_REVERT"] = "SIMULATE_AND_REVERT";
  SafeFeature2["PASSKEY_SIGNER"] = "PASSKEY_SIGNER";
  SafeFeature2["SAFE_L2_CONTRACTS"] = "SAFE_L2_CONTRACTS";
  SafeFeature2["SAFE_MODULE_GUARD"] = "SAFE_MODULE_GUARD";
  return SafeFeature2;
})(SafeFeature || {});
...
var getProtocolKitVersion = () => "7.1.0";
