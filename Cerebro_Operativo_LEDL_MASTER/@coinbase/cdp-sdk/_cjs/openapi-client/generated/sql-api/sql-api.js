...
exports.getSQLSchema = exports.getSQLGrammar = exports.runSQLQuery = void 0;
 ...
 */
const getSQLSchema = (params, options) => {
    return (0, cdpApiClient_js_1.cdpApiClient)({ url: `/v2/data/query/schema`, method: "GET", params }, options);
};
