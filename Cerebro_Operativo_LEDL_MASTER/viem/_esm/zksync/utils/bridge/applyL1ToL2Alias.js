import { pad, toHex } from '/data/data/com.termux/files/home/Cerebro_Operativo_LEDL/07_TRANS_DATA/node_modules/viem/_cjs/../utils/index.js';
import { addressModulo, l1ToL2AliasOffset } from '/data/data/com.termux/files/home/Cerebro_Operativo_LEDL/07_TRANS_DATA/node_modules/viem/_cjs/constants/address.js';
/**
...
export function applyL1ToL2Alias(address) {
    return pad(toHex((BigInt(address) + BigInt(l1ToL2AliasOffset)) % addressModulo), { size: 20 });
}
