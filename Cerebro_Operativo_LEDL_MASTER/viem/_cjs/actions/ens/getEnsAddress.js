...
const trim_js_1 = require("/data/data/com.termux/files/home/Cerebro_Operativo_LEDL/07_TRANS_DATA/node_modules/viem/_cjs/utils/data/trim.js");
...
function decodeAddress({ coinType, data, args, }) {
    try {
        ...
        if (coinType == null)
            throw err;
        const address = (0, trim_js_1.trim)(data);
        if ((0, size_js_1.size)(address) === 20)
            return (0, getAddress_js_1.getAddress)(address);
        throw err;
    }
}
