...
exports.PoolClient = exports.PoolFactory = exports.PoolParamsFactory = exports.APP_SPEC = void 0;
...
class PoolParamsFactory {
    ...
    static get closeOut() {
        return {
             ...
             * @returns An `AppClientMethodCallParams` object for the call
             */
            closeOutOfApplication(params) {
                return {
                    ...params,
                    method: "closeOutOfApplication(uint64)void",
    ...
    * Opt-in the application account to the ASA stored in `this.asset`.
     ...
     * @returns An `AppClientMethodCallParams` object for the call
     */
    static swapToVUsd(params) {
        return {
            ...params,
            method: "swapToVUsd(address,uint64,bool)uint64",
     ...
     * @returns An `AppClientMethodCallParams` object for the call
     */
    static swapFromVUsd(params) {
        return {
            ...params,
            method: "swapFromVUsd(address,uint64,uint64,bool)uint64",
            args: Array.isArray(params.args)
                ? params.args
     ...
     * @returns An `AppClientMethodCallParams` object for the call
     */
    static setFeeShare(params) {
        return {
            ...params,
            method: "setFeeShare(uint64)void",
     ...
     * @returns An `AppClientMethodCallParams` object for the call
     */
    static adjustTotalLpAmount(params) {
        return {
            ...params,
            method: "adjustTotalLpAmount()void",
            args: Array.isArray(params.args) ? params.args : [],
        };
    }
    /**
     ...
     * @returns An `AppClientMethodCallParams` object for the call
     */
    static setBalanceRatioMinBp(params) {
        return {
            ...params,
            method: "setBalanceRatioMinBP(uint64)void",
     ...
     * @returns An `AppClientMethodCallParams` object for the call
     */
    static stopDeposit(params) {
        return {
            ...params,
            method: "stopDeposit()void",
            args: Array.isArray(params.args) ? params.args : [],
        };
    }
    /**
     ...
     * @returns An `AppClientMethodCallParams` object for the call
     */
    static startDeposit(params) {
        return {
            ...params,
            method: "startDeposit()void",
            args: Array.isArray(params.args) ? params.args : [],
        };
    }
    /**
     ...
     * @returns An `AppClientMethodCallParams` object for the call
     */
    static stopWithdraw(params) {
        return {
            ...params,
            method: "stopWithdraw()void",
            args: Array.isArray(params.args) ? params.args : [],
        };
    }
    /**
     ...
     * @returns An `AppClientMethodCallParams` object for the call
     */
    static startWithdraw(params) {
        return {
            ...params,
            method: "startWithdraw()void",
            args: Array.isArray(params.args) ? params.args : [],
        };
    }
    /**
     ...
     * @returns An `AppClientMethodCallParams` object for the call
     */
    static setRouter(params) {
        return {
            ...params,
            method: "setRouter(address)void",
     ...
     * @returns An `AppClientMethodCallParams` object for the call
     */
    static setAdminFeeShare(params) {
        return {
            ...params,
            method: "setAdminFeeShare(uint64)void",
     ...
     * @returns An `AppClientMethodCallParams` object for the call
     */
    static claimAdminFee(params) {
        return {
            ...params,
            method: "claimAdminFee()void",
            args: Array.isArray(params.args) ? params.args : [],
        };
    }
    /**
     ...
     * @returns An `AppClientMethodCallParams` object for the call
     */
    static pendingReward(params) {
        return {
            ...params,
            method: "pendingReward(address)uint64",
...
exports.PoolParamsFactory = PoolParamsFactory;
/**
...
class PoolClient {
    ...
    static async fromCreatorAndName(params) {
        return new PoolClient(await app_client_1.AppClient.fromCreatorAndName({ ...params, appSpec: exports.APP_SPEC }));
    }
    /**
    ...
    static async fromNetwork(params) {
        return new PoolClient(await app_client_1.AppClient.fromNetwork({ ...params, appSpec: exports.APP_SPEC }));
    }
    ...
    params = {
        ...
        optIn: {
             ...
             */
            optInToApplication: (params = { args: [] }) => {
        ...
        closeOut: {
             ...
             */
            closeOutOfApplication: (params = { args: [undefined] }) => {
        ...
        * Opt-in the application account to the ASA stored in `this.asset`.
         ...
         * @returns The call params
         */
        adjustTotalLpAmount: (params = { args: [] }) => {
    ...
    send = {
        ...
        optIn: {
             ...
             */
            optInToApplication: async (params = { args: [] }) => {
        ...
        closeOut: {
             ...
             */
            closeOutOfApplication: async (params = { args: [undefined] }) => {
        ...
        * Opt-in the application account to the ASA stored in `this.asset`.
         ...
         * @returns The call result
         */
        adjustTotalLpAmount: async (params = { args: [] }) => {
         ...
         * @returns The call result
         */
        setBalanceRatioMinBp: async (params) => {
         ...
         * @returns The call result
         */
        startDeposit: async (params = { args: [] }) => {
         ...
         * @returns The call result
         */
        stopWithdraw: async (params = { args: [] }) => {
         ...
         * @returns The call result
         */
        startWithdraw: async (params = { args: [] }) => {
         ...
         * @returns The call result
         */
        claimRewards: async (params = { args: [] }) => {
         ...
         * @returns The call result
         */
        claimAdminFee: async (params = { args: [] }) => {
    ...
    state = {
        ...
        global: {
             ...
             */
            feeShareBp: async () => {
                return (await this.appClient.state.global.getValue("feeShareBP"));
            },
            /**
             * Get the current value of the router key in global state
             */
            router: async () => {
                return (await this.appClient.state.global.getValue("router"));
            },
            /**
             * Get the current value of the tokenBalance key in global state
             */
            tokenBalance: async () => {
                return (await this.appClient.state.global.getValue("tokenBalance"));
            },
            /**
             * Get the current value of the vUsdBalance key in global state
             */
            vUsdBalance: async () => {
                return (await this.appClient.state.global.getValue("vUsdBalance"));
            },
            /**
             * Get the current value of the balanceRatioMinBP key in global state
             */
            balanceRatioMinBp: async () => {
                return (await this.appClient.state.global.getValue("balanceRatioMinBP"));
            },
            /**
             * Get the current value of the reserves key in global state
             */
            reserves: async () => {
                return (await this.appClient.state.global.getValue("reserves"));
            },
            /**
             * Get the current value of the a key in global state
             */
            a: async () => {
                return (await this.appClient.state.global.getValue("a"));
            },
            /**
             * Get the current value of the d key in global state
             */
            d: async () => {
                return (await this.appClient.state.global.getValue("d"));
            },
            /**
             * Get the current value of the tokenAmountReduce key in global state
             */
            tokenAmountReduce: async () => {
                return (await this.appClient.state.global.getValue("tokenAmountReduce"));
            },
            /**
             * Get the current value of the tokenAmountIncrease key in global state
             */
            tokenAmountIncrease: async () => {
                return (await this.appClient.state.global.getValue("tokenAmountIncrease"));
            },
            /**
             ...
             */
            canDeposit: async () => {
                return (await this.appClient.state.global.getValue("canDeposit"));
            },
            /**
             * Get the current value of the canWithdraw key in global state
             */
            canWithdraw: async () => {
                return (await this.appClient.state.global.getValue("canWithdraw"));
            },
            /**
             * Get the current value of the asset key in global state
             */
            asset: async () => {
                return (await this.appClient.state.global.getValue("asset"));
            },
            /**
             * Get the current value of the adminFeeShareBP key in global state
             */
            adminFeeShareBp: async () => {
                return (await this.appClient.state.global.getValue("adminFeeShareBP"));
            },
            /**
             ...
             */
            accRewardPerShareP: async () => {
                return new BinaryStateValue((await this.appClient.state.global.getValue("accRewardPerShareP")));
            },
            /**
             * Get the current value of the adminFeeAmount key in global state
             */
            adminFeeAmount: async () => {
                return (await this.appClient.state.global.getValue("adminFeeAmount"));
            },
            /**
         ...
         */
        local: (address) => {
            const encodedAddress = typeof address === "string" ? address : (0, algosdk_1.encodeAddress)(address.publicKey);
            return {
                /**
                 ...
                 */
                balance: async () => {
                    return (await this.appClient.state.local(encodedAddress).getValue("balance"));
                },
                /**
                 * Get the current value of the userRewardDebt key in local state
                 */
                userRewardDebt: async () => {
                    return (await this.appClient.state.local(encodedAddress).getValue("userRewardDebt"));
                },
            };
        },
    };
    newGroup() {
        ...
        return {
             ...
             */
            swapToVUsd(params) {
                promiseChain = promiseChain.then(async () => composer.addAppCallMethodCall(await client.params.swapToVUsd(params)));
             ...
             */
            swapFromVUsd(params) {
                promiseChain = promiseChain.then(async () => composer.addAppCallMethodCall(await client.params.swapFromVUsd(params)));
             ...
             */
            setFeeShare(params) {
                promiseChain = promiseChain.then(async () => composer.addAppCallMethodCall(await client.params.setFeeShare(params)));
                resultMappers.push(undefined);
                return this;
            },
            /**
             ...
             */
            adjustTotalLpAmount(params) {
                promiseChain = promiseChain.then(async () => composer.addAppCallMethodCall(await client.params.adjustTotalLpAmount(params)));
                resultMappers.push(undefined);
                return this;
            },
            /**
             ...
             */
            setBalanceRatioMinBp(params) {
                promiseChain = promiseChain.then(async () => composer.addAppCallMethodCall(await client.params.setBalanceRatioMinBp(params)));
                resultMappers.push(undefined);
                return this;
            },
            /**
             ...
             */
            stopDeposit(params) {
                promiseChain = promiseChain.then(async () => composer.addAppCallMethodCall(await client.params.stopDeposit(params)));
                resultMappers.push(undefined);
                return this;
            },
            /**
             ...
             */
            startDeposit(params) {
                promiseChain = promiseChain.then(async () => composer.addAppCallMethodCall(await client.params.startDeposit(params)));
                resultMappers.push(undefined);
                return this;
            },
            /**
             ...
             */
            stopWithdraw(params) {
                promiseChain = promiseChain.then(async () => composer.addAppCallMethodCall(await client.params.stopWithdraw(params)));
                resultMappers.push(undefined);
                return this;
            },
            /**
            ...
            startWithdraw(params) {
                promiseChain = promiseChain.then(async () => composer.addAppCallMethodCall(await client.params.startWithdraw(params)));
                resultMappers.push(undefined);
                return this;
            },
            /**
             ...
             */
            setRouter(params) {
                promiseChain = promiseChain.then(async () => composer.addAppCallMethodCall(await client.params.setRouter(params)));
                resultMappers.push(undefined);
                return this;
            },
            /**
             ...
             */
            setAdminFeeShare(params) {
                promiseChain = promiseChain.then(async () => composer.addAppCallMethodCall(await client.params.setAdminFeeShare(params)));
                resultMappers.push(undefined);
                return this;
            },
            /**
             ...
             */
            claimAdminFee(params) {
                promiseChain = promiseChain.then(async () => composer.addAppCallMethodCall(await client.params.claimAdminFee(params)));
                resultMappers.push(undefined);
                return this;
            },
            /**
             ...
             */
            pendingReward(params) {
                promiseChain = promiseChain.then(async () => composer.addAppCallMethodCall(await client.params.pendingReward(params)));
            ...
            get optIn() {
                return {
                    ...
                    deposit: (params) => {
                        promiseChain = promiseChain.then(async () => composer.addAppCallMethodCall(await client.params.optIn.deposit(params)));
                        resultMappers.push(undefined);
                        return this;
                    },
                };
