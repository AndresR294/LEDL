...
class YieldDoesNotSupportedError extends SdkRootError {
    constructor(message) {
        super(ErrorCode.YIELD_DOES_NOT_SUPPORTED_ERROR, message);
    }
}
exports.YieldDoesNotSupportedError = YieldDoesNotSupportedError;
...
(function (ErrorCode) {
    ...
    ErrorCode["YIELD_DOES_NOT_SUPPORTED_ERROR"] = "YieldDoesNotSupportedError";
