...
describe('find page middleware', () => {
  test('attaches page on req.context', async () => {
    ...
    req.context.pages = {
      '/en/foo/bar': await Page.init({
        ...
        basePath: path.join(__dirname, '/data/data/com.termux/files/home/Cerebro_Operativo_LEDL/07_TRANS_DATA/node_modules/viem/_cjs/../src/fixtures/fixtures'),
        languageCode: 'en',
      }),
    }
  ...
  test('re-reads from disk if in development mode', async () => {
    ...
    await findPage(req, res, () => {}, {
      isDev: true,
      contentRoot: path.join(__dirname, '/data/data/com.termux/files/home/Cerebro_Operativo_LEDL/07_TRANS_DATA/node_modules/viem/_cjs/../src/fixtures/fixtures'),
    })
    expect(req.context.page).toBeInstanceOf(Page)
  })
